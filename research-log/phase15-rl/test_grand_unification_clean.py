...
# TEST data for evaluation (held out from Critic training)
DATA_FILE = "research-log/phase15-rl/data/grpo_test_labeled.jsonl"
# Critic trained on TRAIN data only
CRITIC_CHECKPOINT = "research-log/phase15-rl/checkpoints_critic_clean/critic_e3.pt"
MAX_LEN = 512
BATCH_SIZE = 32
...
def evaluate_combined():
    print("="*50)
    print("CLEAN EVALUATION: Critic trained on TRAIN, evaluated on TEST")
    print("="*50)
    ...
    print("Loading CLEAN Critic (trained on TRAIN data only)...")
    ...
    print("="*50)
    print("CLEAN GRAND UNIFICATION RESULTS")
    print("="*50)
    ...
    print(f"Critic Selection Efficiency: {(pass_critic/total)/(pass_oracle/total)*100:.1f}% of oracle")
    print("="*50)
