...
CHECKPOINT_PATH = "research-log/phase15-rl/checkpoints/grpo_e5.pt"
OUTPUT_FILE = "research-log/phase15-rl/data/grpo_train_generations.jsonl"
NUM_SAMPLES = 50
TEMP = 0.8

def generate_grpo_train():
    # HF format should already exist from test generation
    ...
    # TRAIN split instead of test
    print("Loading MBPP TRAIN Data...")
    ...
    print(f"Generating {len(prompts) * NUM_SAMPLES} solutions ({len(prompts)} problems x {NUM_SAMPLES} samples)...")
